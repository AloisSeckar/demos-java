...
| **`2026-08-05`** | [Java 28 Starts to Take Shape](https://www.infoworld.com/article/4205791/java-28-starts-to-take-shape.html) - three JEPs are already targeted into the future JDK release next March |
...
| **`2026-07-28`** | [To Cache or Not to Cache Virtual Threads](https://quarkus.io/blog/to-cache-or-not-to-cache-virtual-threads/) - **Quarkus** benchmarks pooling **virtual threads** and finds it backfires for smaller heaps |
...
| **`2026-07-14`** | [Oracle Introduces AI-Native Builder Experience](https://www.oracle.com/news/announcement/oracle-introduces-ai-native-builder-experience-2026-07-14/) - meet **AI Studio Skill**, a new AI-native builder experience for creating Fusion Agentic Applications with no-code, low-code, and pro-code development using VS Code, Codex, Claude Code, and Git workflows |
...
| **`2026-07-15`** | [Can You Use Java for AI?](https://www.danvega.dev/blog/can-you-use-java-for-ai) - the article argues that as AI work shifts from model training to integration, the Java-based JVM tools are better suited for building production AI applications |
...
| **`2026-07-09`** | [The Java Story: A Film About All of Us](https://foojay.io/today/the-java-story-a-film-about-all-of-us/) - an annonucement of the documentary YouTube movie tracing 31 years of **Java** and **Jakarta EE** history |
...
| **`2026-06-09`** | [Spring Data 2026.0.0 generally available](https://spring.io/blog/2026/06/09/spring-data-2026-0-0-generally-available) - **Spring Data 4.1** release featuring type-safe property paths, annotated Redis Pub/Sub message listeners, revised MongoDB Bulk API, and JDBC/R2DBC single-statement upsert |
...
| **`2026-05-21`** | [WildFly 40 is released!](https://www.wildfly.org/news/2026/05/21/WildFly-40-is-released/) - **WildFly 40** released with EE 11 support, new WildFly EE 10 variant, Hashicorp Vault integration, OIDC logout support, brute force attack mitigation, and updated dependencies including Hibernate 7.3.2 |
