...
Currently, the focus is on implementing demos for all features of <s>[JDK 25](https://github.com/AloisSeckar/demos-java/issues/29)</s>, [JDK 24](https://github.com/AloisSeckar/demos-java/issues/28), [JDK 23](https://github.com/AloisSeckar/demos-java/issues/1), [JDK 22](https://github.com/AloisSeckar/demos-java/issues/13) and [JDK 21](https://github.com/AloisSeckar/demos-java/issues/25), in given order. However, if you feel like creating demo for some older JEP, you are very much welcome to do so! Just let me know by opening an issue, so it can be properly tracked and your contribution can be recognized. Rememeber, most of the JEPs are not covered at all so far.
