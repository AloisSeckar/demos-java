...
- [JEP 429: Scoped Values (Incubator)](https://openjdk.java.net/jeps/429)
...
- [JEP 438: Vector API (Fifth Incubator)](https://openjdk.java.net/jeps/438)
...
- [JEP 389: Foreign Function & Memory API (Incubator)](https://openjdk.java.net/jeps/389)
    - An incubating feature that aims to provide a pure Java API for interacting with native code and memory, aiming to be an alternative to JNI. This should make it easier and safer to interact with native libraries.

- [JEP 391: macOS/AArch64 Port](https://openjdk.java.net/jeps/391)
    - Adds a macOS/AArch64 port to the JDK. This allows the JDK to run natively on Apple's M1 chips, without relying on Rosetta translation.

- [JEP 393: Foreign-Memory Access API (Third Incubator)](https://openjdk.java.net/jeps/393)
    - This is the third incubation round for an API that enables efficient, safe and concise access to native memory segments from Java code. It aims to eventually replace ByteBuffer for many use-cases.

- [JEP 394: Pattern Matching for instanceof](https://openjdk.java.net/jeps/394)
    - Allows for more expressive and safe code constructs by introducing pattern matching for the `instanceof` operator. It eliminates the need for explicit casting and makes code easier to read.

- [JEP 395: Records](https://openjdk.java.net/jeps/395)
    - Introduces records, a new kind of type declaration in the Java language. Records aim to provide a simple and compact syntax for declaring classes that are intended to be immutable data carriers.
- 
- [JEP 396: Strongly Encapsulate JDK Internals](https://openjdk.java.net/jeps/396)
    - Strongly encapsulates all internal elements of the JDK, except for critical internal APIs such as `sun.misc.Unsafe`. This aims to improve security and maintainability.

- [JEP 411: Deprecate the Security Manager for Removal](https://openjdk.java.net/jeps/411)
    - Deprecates the Security Manager and the `java.security.policy` tool for future removal. This is part of an effort to simplify the JDK and encourage the development of alternative, more modern security mechanisms.

- [JEP 412: Foreign Function & Memory API (Second Incubator)](https://openjdk.java.net/jeps/412)
    - Second incubation of the Foreign Function & Memory API that aims to improve the interaction between Java and native libraries, intending to make it more efficient and safer.
...
- [JEP 222: jshell: The Java Shell](https://openjdk.java.net/jeps/222)
...
- [JEP 237: Linux/RISC-V Port](https://openjdk.java.net/jeps/237)
...
- [JEP 239: Remove the Applet API](https://openjdk.java.net/jeps/239)
...
- [JEP 245: Validate JVM Command-Line Flag Arguments](https://openjdk.java.net/jeps/245)
...
- [JEP 297: Unified arm32/arm64 Port](https://openjdk.java.net/jeps/297)
    - Unifies the source code for the arm32 and arm64 ports into a single forest.

- [JEP 298: Remove Demos and Samples](https://openjdk.java.net/jeps/298)
    - Removes the demos and samples from the JDK.

- [JEP 299: Reorganize Documentation](https://openjdk.java.net/jeps/299)
