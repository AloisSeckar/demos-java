...
public class RemoveRmiActivationDemo implements IDemo {
    ...
    public void demo() {
        ...
        */
        ...
        System.out.println("The RMI Activation mechanism (java.rmi.activation package and rmid tool) was removed in JDK 17.");
        System.out.println("Core RMI functionality remains available.");
        System.out.println("See comments in the source code for more details.");
    }
}