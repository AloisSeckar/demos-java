...
import org.javademos.java25.jep512.CompactSourceFilesAndInstanceMainMethods;
...
public class Java25 {
    ...
    public static ArrayList<IDemo> getDemos() {
        ...
        // JEP 512
        java25DemoPool.add(new CompactSourceFilesAndInstanceMainMethods());
        // JEP 513
        java25DemoPool.add(new FlexibleConstructorBodiesDemo());
        // JEP 514
        java25DemoPool.add(new AheadOfTimeCLIDemo());
        // JEP 515
        java25DemoPool.add(new AheadOfTimeMethodProfilingDemo());
        // JEP 518
