...
public class CompactSourceFilesDemo implements IDemo {
    ...
    public void demo() {
        ...
        // A source file can now omit the class declaration.
        // Compare implementation of `BasicHelloWorld.java` and `CompactHelloWorld.java`
        // in `resources5/jep512` folder.
        //
        // Both files can be run directly to see the output:
        // - java src/main/resources/jep512/BasicHelloWorld.java
        // - java src/main/resources/jep512/CompactHelloWorld.java
        
        // --- 3. Console I/O with `java.lang.IO` ---
        // The new `java.lang.IO` class simplifies console interaction.
        // "Instead of `System.out.println`, we can use `IO.println`.
        // 
        // Note: We avoid calling IO.readln() here to prevent blocking the demo runner.
        // Uncomment following to see it in action.
        // System.out.println("Example of reading input: String name = IO.readln(\"Enter name: \");");

        // --- 4. Automatic Imports ---
        // In compact source files, classes from `java.base` are auto-imported.
        // For example, `java.util.List` can be used without an import statement.
